...
import 'package:kanban_app/shared/overlays/bottom_sheets/task_board/task_comments/task_comments_bottom_sheet.dart';
...
class AppBottomSheetService {
  ...
  showTaskCommentsBottomSheet(
    ...
    return await showCupertinoModalBottomSheet<List<String>?>(
      ...
      context: context,
      backgroundColor: AppTheme.colors(context).surface,
      builder: (context) => TaskCommentsBottomSheet(
        taskId: taskId,
        projectId: projectId,
      ),
    );
